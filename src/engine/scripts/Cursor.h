...
namespace LouiEriksson {
	...
	private:
		...
		inline const static Cursor::State s_Default = State(); // Default Cursor state.
		inline       static Cursor::State s_Pending = State(); // Pending Cursor state. Will be applied next frame.
		inline       static Cursor::State s_Current = State(); // The actual current state of the Cursor.
