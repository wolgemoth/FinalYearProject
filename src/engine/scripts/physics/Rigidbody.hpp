#ifndef FINALYEARPROJECT_RIGIDBODY_HPP
#define FINALYEARPROJECT_RIGIDBODY_HPP
...
namespace LouiEriksson::Engine::Physics {
	...
	public:
		...
		[[nodiscard]] virtual std::type_index TypeID() const noexcept override { return typeid(Rigidbody); };
		 ...
		 */
		[[nodiscard]] const glm::quat& Rotation() {
...
#endif //FINALYEARPROJECT_RIGIDBODY_HPP