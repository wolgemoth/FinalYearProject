...
namespace LouiEriksson {
	...
	public:
		...
		[[maybe_unused]] bool Add(const Tk& _key, const Tv& _value)  {
			...
			// Create an index using the key's hash value "wrapped" with the bucket count.
			size_t hash = GetHashcode(_key);
			size_t i = hash % m_Buckets.size();
	
			auto& bucket = m_Buckets[i];
	
			// During a hash collision, ensure a unique key.
		...
		/// <param name="_key">Key of the entry.</param>
		/// <param name="_value">Value of the entry.</param>
		[[maybe_unused]] void Assign(const Tk& _key, const Tv& _value) {
		...
		/// <returns>True if successful, false otherwise.</returns>
		[[maybe_unused]] bool Remove(const Tk& _key) {
			...
			// During access of a "collided" hash, find the value in the bucket using equality checks.
		...
		/// <returns>True if successful, false otherwise.</returns>
		[[maybe_unused]] bool Get(const Tk& _key, Tv& _out) {
		...
		/// </summary>
		[[maybe_unused]] std::vector<Tk> Keys() {
		...
		/// </summary>
		[[maybe_unused]] std::vector<Tv> Values() {
		...
		/// </summary>
		[[maybe_unused]] std::vector<std::pair<Tk, Tv>> GetAll() {
