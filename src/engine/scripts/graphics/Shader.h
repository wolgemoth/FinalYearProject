...
namespace LouiEriksson::Engine::Graphics {
	...
	private:
		...
		inline void AttachShaders() const {
	...
	public:
		...
		*/
		inline static void Bind(const GLint& _id) {
		 ...
		 */
		inline void BindAttribute(const GLint& _pos, const char* _name) const { glBindAttribLocation(ID(), _pos, _name); }
		 ...
		 */
		inline GLint AttributeID(const std::string& _name, const bool& _verbose = false) {
		 ...
		 */
		inline static void Assign(const GLint& _id, const bool& _value) { glUniform1i (_id, static_cast<GLint>(_value)); }
		 ...
		 */
		inline static void Assign(const GLint& _id, const GLint& _value) { glUniform1i (_id, _value); }
		 ...
		 */
		inline static void Assign(const GLint& _id, const GLuint& _value) { glUniform1ui(_id, _value); }
		 ...
		 */
		inline static void Assign(const GLint& _id, const GLfloat& _value)  { glUniform1f (_id, _value); }
		 ...
		 */
		inline static void Assign(const GLint& _id, const GLfloat& _x, const GLfloat& _y) { glUniform2f(_id, _x, _y);         }
		 ...
		 */
		inline static void Assign(const GLint& _id, const GLfloat& _x, const GLfloat& _y, const GLfloat& _z) { glUniform3f(_id, _x, _y, _z);     }
		 ...
		 */
		inline static void Assign(const GLint& _id, const GLfloat& _x, const GLfloat& _y, const GLfloat& _z, const GLfloat& _w) { glUniform4f(_id, _x, _y, _z, _w); }
		 ...
		 */
		inline static void Assign(const GLint& _id, const glm::vec2& _value) { glUniform2fv(_id, 1, glm::value_ptr(_value)); }
		 ...
		 * @param[in] _value   The vector to assign.
		 */
		inline static void Assign(const GLint& _id, const glm::vec3& _value) { glUniform3fv(_id, 1, glm::value_ptr(_value)); }
		 ...
		 * @param[in] _value The vector to assign.
		 */
		inline static void Assign(const GLint& _id, const glm::vec4& _value) { glUniform4fv(_id, 1, glm::value_ptr(_value)); }
		 ...
		 */
		inline static void Assign(const GLint& _id, const glm::mat2& _mat) { glUniformMatrix2fv(_id, 1, GL_FALSE, glm::value_ptr(_mat)); }
		...
		* @param[in] _mat The matrix to assign.
		*/
		inline static void Assign(const GLint& _id, const glm::mat3& _mat) { glUniformMatrix3fv(_id, 1, GL_FALSE, glm::value_ptr(_mat)); }
		 ...
		 * @param[in] _mat The matrix to assign.
		 */
		inline static void Assign(const GLint& _id, const glm::mat4& _mat) { glUniformMatrix4fv(_id, 1, GL_FALSE, glm::value_ptr(_mat)); }
		 ...
		 */
		inline static void Assign(const GLint& _id, const Texture& _texture, const GLint& _imageUnit)  {
		 ...
		 */
		inline static void Assign(const GLint& _id, const Cubemap& _texture, const GLint& _imageUnit) {
		 ...
		 */
		inline static void Assign(const GLint& _id, const Light::Parameters::ShadowMap& _texture, const GLint& _imageUnit) {
		 ...
		 */
		inline static void AssignDepth(const GLint& _id, const RenderTexture& _texture, const GLint& _imageUnit) {
