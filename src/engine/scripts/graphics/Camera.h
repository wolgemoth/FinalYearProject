...
namespace LouiEriksson::Engine::Graphics {
	...
	private:
		 ...
		 */
		inline static void Draw(const Graphics::Mesh& _mesh) {
	...
	public:
		...
		*/
		 ...
		 */
		inline void FOV(const float& _fov) noexcept {
		 ...
		 */
		inline void NearClip(const float& _nearClip) noexcept {
		 ...
		 */
		inline void FarClip(const float& _farClip) noexcept {
		 ...
		 */
		inline static void ClearColor(glm::vec4 _color) {
		 ...
		 */
		[[nodiscard]] inline static glm::vec4 ClearColor() {
		 ...
		 */
		[[nodiscard]] inline glm::mat4 View() const {
