...
#define _LIGHTING_UTILS
    ...
    // @Assessor: Hard and PCF shadows derived from implementations by Learn OpenGL:
    ...
    // @Assessor: Shadows for Parallax Occlusion Mapping. Implementation courtesy of "Rabbid76":
